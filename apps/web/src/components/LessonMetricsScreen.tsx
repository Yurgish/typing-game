...
const LessonMetricsScreen = () => {
  const { getNextLesson, setCurrentLessonId, setCurrentScreenOrder, getCurrentLesson, currentScreenOrder } =
    ...
    <div className="w-full">
      <div className="mb-6">
        <h2 className="mb-4 text-4xl">
          Lesson {currentScreenOrder} -&gt; {getCurrentLesson()?.title}
        </h2>
      ...
      <Button className="mt-6" onClick={handleNextScreen}>
        Continue
      </Button>
    </div>
  );
